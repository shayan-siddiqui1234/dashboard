...
function Scoreboard() {
    ...
    return (
        <div style={{ margin: "1rem" }} id="border">

            <b><h1><center>  DASHBOARD</center> </h1></b>
         <center>   <h3>Controlling System For Admin </h3></center>
 ...
 <div  id="border1">  <h2>Live Streaminng  </h2>  <h2>Super Shot  </h2>  <h2>.  </h2> </div>
        </div>
